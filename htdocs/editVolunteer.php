...
<?php
   ...
   if($volInfo != "")
   {
	   ...
	   //build query
	   $sql = "SELECT CONCAT(first_name, ' ', last_name) as name, phone, address_line_1, zipCode, email, state FROM volunteer v INNER JOIN address addr ON addr.address_id = v.address_id ".$postQuery;
...
<body>
     ...
     <script language = "javascript" type = "text/javascript">	
			function submitChanges(){
			   ...
			   ajaxRequest.open("GET", "submitChanges.php" + volInfo, true);
